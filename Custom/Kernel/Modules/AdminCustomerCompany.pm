...
sub _CustomerDetails {
    ...
    my @CustomertHistoryDeatils = $Self->CustomerHistoryGet(
    ...
    my $Time;
    for my $Data (@CustomertHistoryDeatils) {
...
sub CustomerHistoryGet {
    ...
    return if !$DBObject->Prepare(
        SQL => 'SELECT name,customer_id ,owner_id,create_time,create_by,change_time,change_by from customer_history where customer_id = ? ',
