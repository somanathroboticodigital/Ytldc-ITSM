...
/**
 * @namespace
 * @exports TargetNS as Question.Agent.ConfirmationDialog
 * @description
 *      This namespace contains the special module functions for ConfirmationDialog.
 */
Question.Agent.ConfirmationDialog = (function (TargetNS) {
    /**
     * @name DialogData
     * @memberof Question.Agent.ConfirmationDialog
     * @variable
     * @private
     * @description
    ...
    TargetNS.BindConfirmationDialog = function (Data) {        
        ...
        $(DialogData[Data.ElementID].ElementSelector).bind('click', Question.Agent.ConfirmationDialog.ShowConfirmationDialog);
    };

    return TargetNS;
}(Question.Agent.ConfirmationDialog || {}));
