...
/**
 * @namespace
 * @exports TargetNS as PaS.Agent.ConfirmationDialog
 * @description
 *      This namespace contains the special module functions for ConfirmationDialog.
 */
PaS.Agent.ConfirmationDialog = (function (TargetNS) {

    /**
     * @name DialogData
     * @memberof PaS.Agent.ConfirmationDialog
     * @variable
     * @private
     * @description
    ...
    TargetNS.BindConfirmationDialog = function (Data) {
        ...
        $(DialogData[Data.ElementID].ElementSelector).bind('click', PaS.Agent.ConfirmationDialog.ShowConfirmationDialog);
    };

    return TargetNS;
}(PaS.Agent.ConfirmationDialog || {}));
